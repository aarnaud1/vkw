...
using DeviceImage = typename Image<MemoryType::Device>;
using HostStagingImage = typename Image<MemoryType::HostStaging>;
using HostImage = typename Image<MemoryType::Host>;
using HostToDeviceImage = typename Image<MemoryType::HostToDevice>;
using DeviceToHostImage = typename Image<MemoryType::DeviceToHost>;
} // namespace vkw
